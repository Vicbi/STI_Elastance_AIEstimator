...
def plot_data(data1,data2,experiment_type,prediction_variable,regressor,save_figure_boolean):
    ...
    if prediction_variable == 'Ees': 
        xmin = 0.5; xmax = 5; ymin = xmin; ymax = xmax; err = 1; 
        temp_ticks = [x/2 for x in range(1, 11)]
    ...
    if prediction_variable == 'dead_volume': 
        xmin = -20; xmax = 60; ymin = xmin; ymax = xmax; err = 40; 
        temp_ticks = list(range(-20, 61, 20))
        ylabel_name1 = 'Predicted Vd [mL]'; xlabel_name1 ='Reference Vd [mL]'; 
        ylabel_name2 ='Vd Error [mL]'; xlabel_name2 ='Average Vd [mL]'
        file_suffix = 'Vd'; unit = 'mL'
    ...
    axs[0].scatter(data2, data1, marker="o",color="k",alpha=0.2,s=15)
